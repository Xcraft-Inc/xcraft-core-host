...
class Menu {
  ...
  append() {
    return this.#menu.append.apply(this.#menu, arguments);
  }

  popup() {
    this.#menu.popup.apply(this.#menu, arguments);
  }

  static buildFromTemplate() {
    return electron.Menu.buildFromTemplate.apply(electron.Menu, arguments);
  }
}
...
class Neutron {
  ...
  // NEW API
  wmSetOverlayIcon(iconPath, label) {
    this.#WM.instance.currentWindow.setOverlayIcon(
  ...
  wmSetIcon(iconPath) {
    if (process.platform === 'darwin') {
      ...
      this.#WM.instance.currentWindow.setIcon(iconPath);
    }
  }
}
